...
import { filterWarnings } from "webpack/lib/Stats";
...
export class Message extends Model {
                ...
                <div class="_3_7SH kNKwo tail">
                    ...
                    <div class="_1YNgi copyable-text">
                        <div class="_3DZ69" role="button">
                            ...
                            <div class="_1lC8v">
                                <div dir="ltr" class="_3gkvk selectable-text invisible-space copyable-text">${this.content.nome}</div>
                            </div>
                            <div class="_3a5-b">
                            ...
                            <div>
                                ...
                                <div class="message-container-legend">
                                    <div class="_3zb-j ZhF0n">
                                        <span dir="ltr" class="selectable-text invisible-space copyable-text message-text">${this.content}</span>
                                    </div>
                                </div>
                                <div class="_2TvOE">
                            ...
                            <div class="_2jfIu">
                                ...
                                <div class="_2fuJy">
                                    <div class="_1WliW" style="height: 55px; width: 55px;">
                                        <img src="${this.photo}" class="Qgzj8 gqwaM message-photo" style="display:none">
                                        <div class="_3ZW2E">
                                            <span data-icon="default-user">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 212 212" width="212" height="212">
                                                    <path fill="#DFE5E7" d="M106.251.5C164.653.5 212 47.846 212 106.25S164.653 212 106.25 212C47.846 212 .5 164.654.5 106.25S47.846.5 106.251.5z"></path>
    ...
    static sendDocument(chatId, from, file, filePreview, info){
        ...
        Message.send(chatId, from, file, filePreview).then(msgRef => {            
        ...
        return new Promise((s,f) => {
           ...
           Message.upload(file, from).then(snapshot=>{
            ...
            uploadTask.on('state_changed', e => {
                ...
                /*Message.send(chatId, from, 'image', uploadTask.snapshot.ref.getDownloadURL()).then(()=>{
