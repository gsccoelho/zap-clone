...
import { MicrofoneController } from './MicrofoneController.js';
...
export class WhatsAppController {
        ...
        this._firebase.initAuth()
            .then(response => {
                ...
                this._user.on('datachange', data => {
                    document.querySelector('title').innerHTML = data.name + ' WhatssApp clone';
    ...
    setActiveChat(contact){
        ...
        Message.getRef(this._contactActive.chatId).orderBy('timeStamp')
            .onSnapshot(docs => { //quero esse método sempre em tempo real

                
                
                //scroll ajuste para baixo
                ...
                docs.forEach(doc => { 
                    ...
                    //se esta msg não estiver na tela...
                    if(!this.el.panelMessagesContainer.querySelector('#_' + data.id)){
                        ...
                        let parent = this.el.panelMessagesContainer.querySelector('#_' + data.id).parentNode; //parentNode pega o elemento pai imediato
                    ...
                    if(this.el.panelMessagesContainer.querySelector('#_' + data.id) && me) {
                        ...
                        msgEl.querySelector('.message-status').innerHTML =  (message.getStatusViewElement().outerHTML == null) ? '' : message.getStatusViewElement().outerHTML;
                    ...
                    if(message.type === 'contact'){
                        ...
                        view.querySelector('.btn-message-send').on('click', e => {
                            ...
                            Chat.createIfNotExists(this._user.email, message.content.email).then(chat => {
                                ...
                                let contact = new User(message.contenct.email);
    ...
    initEvents(){
        ...
        //quando da um foco na janela
        window.addEventListener('focus', e=> {
            this._active = true;
        });
        //quando perde o foco ou minimiza a janela
        ...
        this.el.btnSendPicture.on('click', e=>{
            ...
            picture.onload = e => {
                ...
                //define tamanho e altura
                canvas.width = picture.width;
                canvas.height = picture.height;

                //Invertendo imagem
                context.translate(picture.width, 0); //desloca a imagem para o lado
                context.scale(-1, 1); //inverte horizontalmente

                //desenha a imagem novamente
                context.drawImage(picture, 0, 0, canvas.width, canvas.height);
                
                // dps de desenhado, precisa voltar para base64 para fazer o fetch
        ...
        this.el.btnAttachContact.on('click', e=> {
            ...
            this._contactsController.on('select', contact => {
                ...
                Message.sendContact(
                    this._contactActive.chatId,
                    this._user.email, //usuário logado
                    contact
                );
        ...
        this.el.btnSendMicrophone.on('click', e=> {
            ...
            this._microphoneController = new MicrofoneController(this.el.recordMicrophone);
        ...
        this.el.panelEmojis.querySelectorAll('.emojik').forEach(emoji => {
            ...
            emoji.on('click', e => {
                ...
                //this.el.inputText.appendChild(img); sempre add no final
